...
export const ideaClaritySchema = z.object({
  ...
  projectType: z.enum(['web-app', 'mobile-app', 'saas-platform', 'ecommerce', 'api-backend', 'mvp', 'redesign']),
  ...
  mustHaveFeatures: z.array(z.string()).min(1, "Add at least one must-have feature"),
  ...
  budgetRange: z.enum(['$1k-$5k', '$5k-$10k', '$10k-$25k', '$25k-$50k', '$50k+']),
